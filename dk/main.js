...
//function playHesTheLeaderOfTheBunch(){
//var hesTheLeaderOfTheBunch = new Audio("donkey_kong.mp3");
//hesTheLeaderOfTheBunch.play();
//}
//$("#donkey").on("click", playHesTheLeaderOfTheBunch);

function sayDonkeyKong(){
var donkeyKong = new Audio("donkey_kong.mp3");
donkeyKong.play();
}
